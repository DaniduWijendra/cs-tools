...
import CreateEolAnnouncementPlaceholder from "@features/csm-announcements/components/CreateEolAnnouncementPlaceholder";
 ...
 * (CreateCustomerAnnouncementForm today; CreateEolAnnouncementPlaceholder
 * until the EOL flow's own audience resolution is built), so switching kinds
 * never carries state between them and this page has no form fields of its
 * own to reset.
 */
export default function CsmAnnouncementCreatePage(): JSX.Element {
  ...
  return (
    <Box sx={{ width: "100%", px: 3, py: 3 }}>
      ...
      {kind === "customer" ? <CreateCustomerAnnouncementForm /> : <CreateEolAnnouncementPlaceholder />}
    </Box>
  );
}
