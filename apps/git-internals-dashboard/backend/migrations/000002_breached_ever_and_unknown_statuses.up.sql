-- A sticky "was this ever violated" signal, independent of sla_state (which
-- reports TERMINAL once an issue resolves, masking a real past VIOLATED).
-- Backfilled from sla_snapshots history so existing breaches
...
-- renamed or newly added column) — surfaced via
